...
const ICON = styled.div`
	...
	svg {
		height: ${props => (props.svg_con && props.svg_con.height ? props.svg_con.height : '100%')};
		width: ${props => (props.svg_con && props.svg_con.width ? props.svg_con.width : '100%')};
		path {
			fill: ${props =>
				props.active === true || props.hover === true
					? props.hover === true
